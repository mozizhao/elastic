...
def start():
    jid, job_type, batch_size, workers = request.json['job_id'], request.json['job_type'], request.json['batch_size'], request.json['workers']

    start_job(jid, job_type, batch_size, workers)
    return 'success'
